   ...
   {/* Header */}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 mt-8">
          ...
          <div className="flex flex-wrap gap-3">
            <button className="border border-emerald-600 text-emerald-400 px-4 py-2 rounded-lg hover:bg-emerald-600/10">
              Enter Code
            </button>
            <button className="border border-emerald-600 text-emerald-400 px-4 py-2 rounded-lg hover:bg-emerald-600/10">
              Create Code
            </button>
            <button className="bg-[#2dd4bf] px-4 py-2 rounded-lg hover:bg-emerald-600 transition">
              Claim Rewards
            </button>
          </div>
        </div>
        ...
        <div className="bg-[#050f12] rounded-xl">
          ...
          <div className="flex gap-6 px-5 pt-4 border-b border-gray-700">
